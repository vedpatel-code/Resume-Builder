...
const Dashboard = () => {
  ...
  const deleteResume = async (resumeId) => {
    try {
      const confirm = window.confirm('Do you really want to delete this resume? Once deleted, it can’t be recovered.')
      if (confirm) {
  ...
  return (
    // className='min-h-screen' style={{background: "#70c475"}}
    <div>
      <div className="flex justify-center mb-4 mt-6">
          <div className="relative w-full sm:w-64">
            <input
              ...
              className="w-full pl-10 pr-3 py-2 rounded-lg border border-slate-300 focus:ring-2 focus:ring-indigo-500 outline-none"
            />
            <SearchIcon className="absolute left-3 top-2.5 size-5 text-slate-400" />
          </div>
        </div>

      <div className="flex flex-col items-end mt-6 pr-6 bg-">
        {/* <p className="text-2xl font-semibold mb-1 flex items-center gap-2 justify-end text-right">
      ...
      <div className='max-w-7xl mx-auto px-4 py-8'>
        {/* <p className='text-2xl font-medium mb-6 bg-gradient-to-r from-slate-600 to-slate-700 bg-clip-text text-transparent sm:hidden'>Welcome, Ved Patel</p> */}
